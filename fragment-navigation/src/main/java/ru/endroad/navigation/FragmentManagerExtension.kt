 ...
 */
fun FragmentManager.changeRoot(fragment: Fragment, @IdRes container: Int = R.id.fragment) {
 ...
 * @param container id layout'а, в котором будет заменен фрагмент
 */
fun FragmentManager.changeRoot(fragment: Fragment, animation: FragmentAnimation, @IdRes container: Int = R.id.fragment) {
	for (i in 0 until backStackEntryCount) popBackStack()
 ...
 * @param container id layout'а, в котором будет заменен фрагмент
 */
fun FragmentManager.replace(fragment: Fragment, @IdRes container: Int = R.id.fragment) {
 ...
 * @param container id layout'а, в котором будет заменен фрагмент
 */
fun FragmentManager.replace(fragment: Fragment, animation: FragmentAnimation, @IdRes container: Int = R.id.fragment) {
	beginTransaction().run {
		setAnimationTransaction(animation)
		replace(container, fragment)
 ...
 * @param container id layout'а, в котором будет заменен фрагмент
 */
fun FragmentManager.forwardTo(fragment: Fragment, @IdRes container: Int = R.id.fragment) {
 ...
 * @param container id layout'а, в котором будет заменен фрагмент
 */
fun FragmentManager.forwardTo(fragment: Fragment, animation: FragmentAnimation, @IdRes container: Int = R.id.fragment) {
	findFragmentById(container)?.onHiddenChanged(true)
	beginTransaction().run {
		setAnimationTransaction(animation)
		replace(container, fragment)
